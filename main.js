...
if (reason == 405) {
await fs.unlinkSync("./zenonSession/" + "creds.json")
...
let prekey = []
let directorio = readdirSync("./zenonSession")
let filesFolderPreKeys = directorio.filter(file => {
return file.startsWith('pre-key-')
})
prekey = [...prekey, ...filesFolderPreKeys]
filesFolderPreKeys.forEach(files => {
unlinkSync(`./zenonSession/${files}`)
})
} 
...
const directories = ['./zenonSession/', './GataJadiBot/']
