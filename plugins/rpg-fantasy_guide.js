// Código elaborado por: https://github.com/555-Li

let handler = async (m, { command, usedPrefix, conn, text }) => {
let fantasy = `
> *¡Bienvenido a la fascinante bitácora de Fantasy!*

_Aquí, te proporcionaré información esencial para que te conviertas en un maestro en el emocionante mundo de los usuarios *Fantasy* en *zenon*._
...
*¿Te gustaría proponer tus propios personajes para que formen parte de zenon?*
¡Es sencillo! Solo utiliza el comando \`${usedPrefix}fyadd* o *${usedPrefix}fyagregar\` y sigue la guía proporcionada para comenzar a crear tu solicitud de personajes. Los desarrolladores estarán encantados de recibir tus propuestas y considerarlas para enriquecer la experiencia en zenon.
...
*¿Quieres conocer todos los personajes disponibles en zenon?*

Con el comando \`${usedPrefix}fylista o ${usedPrefix}fyl\`, puedes acceder a una lista completa de todos los personajes disponibles en zenon. Además, podrás explorar diferentes categorías.
