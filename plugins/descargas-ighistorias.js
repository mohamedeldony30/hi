...
conn.reply(m.chat, `${lenguajeGB['smsAvisoIIG']()}${mid.smsinfo}`, m, { contextInfo: { externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: 'Zenon-Bot | mohamedelsony', body: 'Super Bot WhatsApp',          previewType: 0, thumbnail: gataMenu, sourceUrl: md}}})
}} catch (e) {
...
handler.command = ['igstory', 'استوري', 'ighistorias' ]
handler.limit = 3
