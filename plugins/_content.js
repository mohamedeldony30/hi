...
var canalesInfo = [
{ link: canal1, id: "1203631600315023229@newsletter", name: "INFINITY-WA 💫" },
{ link: canal2, id: "120363169294t281316@newsletter", name: "GB - UPDATE ✨" },
{ link: canal3, id: "12036320380g5910750@newsletter", name: "Tips sobre zenon 🤩" } 
]
...
global.gataVidMenu = ['https://telegra.ph/file/9902b1bb00ed04f4437fe.mp4', 'https://telegra.ph/file/59de3100583673fd96b62.mp4', 'https://telegra.ph/file/abfa6839113a92afab777.mp4','https://telegra.ph/file/c35fdeee141e12ba2f12c.mp4','https://c.top4top.io/m_30348odfz1.mp4'].getRandom()
...
let enlace2 = { contextInfo: { externalAdReply: { showAdAttribution: true, mediaUrl: yt, mediaType: 'VIDEO', description: '', title: wm, body: '😻 𝗦𝘂𝗽𝗲𝗿 Zenon-Bot - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 ', thumbnailUrl: gataMenu, sourceUrl: accountsgb }}}
let dos = [enlace, enlace2]  

global.wait = "⌛ *`يتم التحميل...`*\n*✪✦✦⊹⊹⊹⊹⊹⊹⊹⊹✪* `20%`"
global.waitt = "⏳ *`يتم التحميل....`*\n*✪✦✦✦✦⊹⊹⊹⊹⊹⊹✪* `40%`"
global.waittt = "⌛ *`يتم التحميل...`*\n*✪✦✦✦✦✦✦⊹⊹⊹⊹✪* `60%`"
global.waitttt = "⏳ *`يتم التحميل....`*\n*✪✦✦✦✦✦✦✦✦⊹⊹✪* `80%`"
global.waittttt = "⌛ *`تم التحميل...`*\n*✪✦✦✦✦✦✦✦✦✦✦✪* `100%`"
