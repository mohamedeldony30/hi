...
let additionalText = ''
if (command === 'اغنيه2' || command == 'playaudiodoc') {
additionalText = '𝘼𝙐𝘿𝙄𝙊'
} else if (command === 'فيديو2' || command == 'playvideodoc') {
...
if (command == 'فيديو2' || command == 'playvideodoc') {
try {
const qu = '360';
const q = qu + 'p';
const v = yt_play[0].url;
...
handler.command = /^(playaudiodoc|playdoc|playdoc2|اغنيه2|فيديو2|playvideodoc)$/i;
//handler.limit = 3
