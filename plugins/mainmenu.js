...
«.التنزيلات » يقوم يتنزيل الفيديوهات من السوشال ميديا و البحث
«.الجروب» يقوم بعرض اوامر التحكم ب الجروبات
«.القران» القران
«.الصوتيات» يقوم الامر بلتعديل علي الصوتيات
«.التسليه» يقوم الامر بعرض اوامر التسلية و الالعاب
«.الصور» يقوم الامر بتعديل الصور 
«.لوجو» يقوم الامر بصنع لوجو
---------------
...
---------------
All ©️ Copyright Reserved Zenonsoftware`.trim()
await conn.sendFile(m.chat, pp, 'lp.jpg', menu, fkontak, false, { contextInfo: {mentionedJid, externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 😻 𝗦𝘂𝗽𝗲𝗿 Zenon-Bot - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 ', previewType: 0, thumbnail: imagen4, sourceUrl: redesMenu}}}) 
...
handler.command = /^(menu|الاوامر|memu|mem1|hel1\?)$/i
...
function ucapan() {
  const time = moment.tz('Africa/Cairo').format('HH')  //Africa/Cairo  Asia/Jakarta   America/Toronto
