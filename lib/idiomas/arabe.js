...
const smsUnreg = () => { return `\`\`\`¡¡أنت بحاجة إلى التسجيل لاستخدام هذا الأمر ، نوع  ( .حساب )للتسجيل أذا لم تفهم برجاء  مشاهده الفيديو  https://telegra.ph/file/9a9ec5b55be05ffb6bc6a.mp4!!\`\`\`` }
